...
class BundleClass extends db_connection
{
    ...
    public function create_bundle($title, $price, $description, $image, $keywords, $product_ids, $discounts)
    {
        try {
            ...
            // First, create the bundle as a product
            ...
            // Use a default category and brand for bundles (you can customize this)
            $cat_id = 1;
            $brand_id = 1;
            $stmt->bind_param("iisdsssi", $cat_id, $brand_id, $title, $price, $description, $image, $keywords);
