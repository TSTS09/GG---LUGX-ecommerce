...
<body>
    ...
    <div class="container">
        ...
        <form id="registrationForm" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    <input type="text" id="customer_contact" placeholder="Enter your phone number" required>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="customer_image" class="text-sm text-gray-600 block mb-1">Profile Image (Optional)</label>
                    <input type="file" id="customer_image" accept="image/*">
                </div>
            </div>
        ...
        <!-- <p class="text-center">
            or maybe need some help? <a href="set_password.php">forgot password</a>
        </p> -->
    </div>
    <!-- </div> -->
